...
const PINYIN: Record<string, string[]> = PINYIN_PAIRS.reduce((acc, [k, v]) => { if (!acc[k]) acc[k] = []; for (const s of v) if (!acc[k].includes(s)) acc[k].push(s); return acc; }, {} as Record<string, string[]>);
...
const ZHUYIN_PAIRS: [string, string][] = [
  ['yín','ㄧㄣˊ'],
  ['xíng','ㄒㄧㄥˊ'],
  ['háng','ㄏㄤˊ'],
  ['mén','ㄇㄣˊ'],
...
const ZHUYIN: Record<string, string> = ZHUYIN_PAIRS.reduce((acc, [k, v]) => { if (!(k in acc)) acc[k] = v; return acc; }, {} as Record<string, string>);

const RARE_PINYIN_PAIRS: [string, string][] = [
  ['囧','jiǒng'],
  ['槑','méi'],
  ['烎','yín'],
  ['玊','sù'],
...
const RARE_PINYIN: Record<string, string> = RARE_PINYIN_PAIRS.reduce((acc, [k, v]) => { if (!(k in acc)) acc[k] = v; return acc; }, {} as Record<string, string>);
