        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 sm:gap-6'>
          <div>
            <a href={`${basePath}/about`} className='block group'>
              <h3 className='font-semibold text-gray-900 dark:text-gray-100 mb-2 sm:mb-3 text-sm sm:text-base group-hover:text-primary-600 dark:group-hover:text-primary-400 transition-colors'>{t('about')}</h3>
              <p className='text-xs sm:text-sm text-gray-600 dark:text-gray-400'>{t('about-desc')}</p>
            </a>
          </div>
          <div>
