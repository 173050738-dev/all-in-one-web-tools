...
export default function Header({ locale }: { locale: string }) {
  ...
  const handleBookmark = () => {
    ...
    const url = 'https://www.korelyy.com';
  ...
  const manualBookmark = () => {
    ...
    if (win.sidebar && win.sidebar.addPanel) {
      win.sidebar.addPanel('Korelyy Tools', 'https://www.korelyy.com', '');
      setShowBookmarkToast(true);
      setTimeout(() => setShowBookmarkToast(false), 2000);
    } else if (ext && ext.AddFavorite) {
      ext.AddFavorite('https://www.korelyy.com', 'Korelyy Tools');
      setShowBookmarkToast(true);
      setTimeout(() => setShowBookmarkToast(false), 2000);
    } else {
      ...
      <div className='max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8'>
        ...
        {mobileMenuOpen && (
          <div className='md:hidden py-3 sm:py-4 border-t border-white/10 space-y-3'>
            ...
            <SearchDropdown locale={locale} isMobile={true} />
