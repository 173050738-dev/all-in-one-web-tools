      ...
      <div className='prose prose-gray dark:prose-invert max-w-none'>
        ...
        <section className='mb-8'>
          ...
          <ul className='list-disc list-inside text-gray-600 dark:text-gray-400 mb-4 space-y-2'>
            ...
            <li>第三方开源组件、字体、素材由对应权利人持有知识产权，我站已获得合法授权使用。</li>
          </ul>
        </section>
        ...
        <section className='mb-8'>
          ...
          <ul className='list-disc list-inside text-gray-600 dark:text-gray-400 mb-4 space-y-2'>
            <li>本站对您承担的全部责任总额，不超过您在过去 12 个月内实际支付给本站的服务费用（如有）；如您未支付任何费用，我站对您的责任总额不超过人民币 100 元；</li>
            <li>本站不对任何间接、附带、特殊、惩罚性或后果性损害承担责任，包括但不限于利润损失、商誉损失、数据丢失、业务中断、预期利益损失等；</li>
            <li>本站对您提供的工具链接、第三方服务的可用性、安全性、准确性不承担保证责任；</li>
            <li>因不可抗力（包括但不限于地震、洪水、台风、疫情、政策变化、监管要求、网络攻击、运营商中断、第三方服务故障等）导致本站无法履行义务的，我站不承担违约责任；</li>
            <li>若本站部分免责条款被有管辖权的法院认定为无效，不影响其他条款的法律效力；</li>
            <li>某些司法管辖区不允许排除或限制某些损害赔偿，因此上述部分限制可能不适用于您；我站的免责条款将在适用法律允许的最大范围内执行。</li>
          </ul>
        </section>
        ...
        <section className='mb-8'>
          ...
          <ul className='list-disc list-inside text-gray-600 dark:text-gray-400 mb-4 space-y-2'>
            ...
            <li>本站不主动收集未成年人信息；如监护人发现未成年人在未经同意的情况下上传了个人信息或隐私文件，可通过 173050738@qq.com 申请立即删除，我站将在 24 小时内核实清理；</li>
