...
export default function TitleWeightChecker({ locale = 'zh' }: TitleWeightCheckerProps) {
  ...
  const analyses = useMemo<TitleAnalysis[]>(() => {
    return titles.map((title, idx) => analyzeTitle(title, idx, mode, t));
  }, [titles, mode, t]);
