...
export default function StepInspector({
  ...
  const openUrl = () => {
    if (externalUrl && typeof window !== 'undefined') {
      safeNavigate(externalUrl, '_blank');
    }
  };
  ...
  return (
    <div className="h-full flex flex-col bg-white dark:bg-gray-800 border-l border-gray-200 dark:border-gray-700">
      <div className="p-3 border-b border-gray-200 dark:border-gray-700 flex items-start gap-2">
        <div className="w-8 h-8 rounded-lg bg-primary-50 dark:bg-primary-900/30 text-primary-600 dark:text-primary-400 flex items-center justify-center flex-shrink-0 mt-0.5">
      ...
      <div className="flex-1 overflow-y-auto">
        {isWaiting && (
          <div className="m-3 p-3 rounded-xl border border-primary-200 dark:border-primary-700 bg-primary-50 dark:bg-primary-900/20">
            <div className="flex items-center gap-2 mb-3">
              <AlertTriangle className="w-4 h-4 text-primary-500 flex-shrink-0" />
              <div className="text-xs font-semibold text-primary-700 dark:text-primary-300 flex-1">
                {t(locale, 'waiting')}
              </div>
            </div>
            {externalUrl && (
              <button
                onClick={openUrl}
                className="w-full mb-2 py-2 px-3 text-xs font-medium bg-white dark:bg-gray-800 text-primary-600 dark:text-primary-400 rounded-lg border border-primary-200 dark:border-primary-700 hover:bg-primary-50 dark:hover:bg-primary-900/30 flex items-center justify-center gap-1.5"
              >
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              <button
                ...
                className="py-2 px-3 text-xs font-medium bg-gradient-to-r from-green-500 to-emerald-500 text-white rounded-lg hover:from-green-600 hover:to-emerald-600 shadow-sm shadow-green-500/25 flex items-center justify-center gap-1"
              >
            ...
            <>
              <Section label={t(locale, 'stepTitle')}>
                <input
                  ...
                  className="w-full px-3 py-2 text-xs rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900/60 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-primary-500/40"
                />
              </Section>
              <Section label={t(locale, 'stepDesc')}>
                <textarea
                  ...
                  className="w-full px-3 py-2 text-xs rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900/60 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-primary-500/40 resize-none"
                />
              </Section>
              {externalUrl && (
                <div>
...
function InputField({
  ...
  const base =
    'w-full px-3 py-2 text-xs rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900/60 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-primary-500/40';
