      ...
      />
        <div className='flex-1 min-w-0'>
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-2.5 sm:gap-3 lg:gap-4'>
            ...
            >
              <div className='w-full bg-gradient-to-r from-amber-400 via-orange-400 to-pink-500 rounded-xl shadow-sm overflow-hidden hover:shadow-lg hover:-translate-y-0.5 active:scale-[0.99] transition-all duration-300 h-full'>
