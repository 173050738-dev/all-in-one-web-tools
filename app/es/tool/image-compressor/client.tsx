            ...
            {originalImage && (
              <div className='space-y-4 sm:space-y-6'>
                <div className='grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4'>
                  ...
                  <div>
                    <div className='flex items-center justify-between mb-2'>
                      <label className='block text-sm font-medium text-gray-700 dark:text-gray-300'>Comprimida</label>
                ...
                <div className='space-y-3 sm:space-y-4 p-3 sm:p-4 bg-gray-50 dark:bg-gray-800/50 rounded-lg'>
                  <div className='flex items-center gap-2'>
                    ...
                    <span className='text-sm font-medium text-gray-700 dark:text-gray-300'>Ajustes de compresión</span>
                  </div>
                  <div className='grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4'>
                    <div>
                      <div className='flex items-center justify-between mb-1'>
                        <label className='text-xs sm:text-sm text-gray-600 dark:text-gray-400'>Calidad</label>
                    ...
                    <div>
                      <div className='flex items-center justify-between mb-1'>
                        <label className='text-xs sm:text-sm text-gray-600 dark:text-gray-400'>Ancho máximo</label>
                      ...
                      >
                        ...
                        <option value={4096}>Sin límite (original)</option>
                      </select>
                    </div>
                  </div>
                </div>
                ...
                <div className='grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4'>
                  ...
                  >
                    {isProcessing ? 'Comprimiendo...' : 'Comenzar compresión'}
                  </button>
                  <button
                  ...
                  >
                    ...
                    Enviar al Cortador en Cuadrícula
                  </button>
                </div>
              </div>
            )}
        ...
        <aside className='lg:col-span-3'>
          <div className='card p-4 sm:p-6'>
            ...
            <p className='text-xs sm:text-sm text-gray-600 dark:text-gray-400 mb-3 sm:mb-4'>
              Ajusta calidad y tamaño tras subir la imagen. Haz clic en comprimir para reducir el archivo. Procesamiento 100% local, sin subidas.
            </p>
            ...
            <ul className='space-y-2'>
              ...
              <li className='flex items-center gap-2 text-xs sm:text-sm text-gray-600 dark:text-gray-400'>
                <span className='w-1.5 h-1.5 rounded-full bg-primary-500' />
                Límite de ancho máximo personalizado
              </li>
              <li className='flex items-center gap-2 text-xs sm:text-sm text-gray-600 dark:text-gray-400'>
                <span className='w-1.5 h-1.5 rounded-full bg-primary-500' />
