        ...
        <aside className='lg:col-span-3'>
          <div className='card p-4 sm:p-6'>
            ...
            <p className='text-xs sm:text-sm text-gray-600 dark:text-gray-400 mb-3 sm:mb-4'>
              Pega el contenido del documento, selecciona una plantilla de formato, visualiza el diseño en tiempo real y exporta a Word o PDF con un solo clic. Admite documentos gubernamentales, formatos académicos APA/MLA, informes empresariales y plantillas de currículum.
            </p>
            ...
            <ul className='space-y-2'>
              ...
              <li className='flex items-center gap-2 text-xs sm:text-sm text-gray-600 dark:text-gray-400'>
                <span className='w-1.5 h-1.5 rounded-full bg-primary-500' />
                Detección Automática de Encabezados H1-H6
              </li>
              <li className='flex items-center gap-2 text-xs sm:text-sm text-gray-600 dark:text-gray-400'>
                <span className='w-1.5 h-1.5 rounded-full bg-primary-500' />
