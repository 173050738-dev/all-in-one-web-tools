        ...
        <main className='lg:col-span-7'>
          <div className='card p-4 sm:p-6'>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6'>
              <div className='space-y-4'>
                <div>
                  <label className='block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2'>Contenido QR</label>
                  <textarea
                    value={text}
                    onChange={(e) => setText(e.target.value)}
                    placeholder='Introduce URL, texto o cualquier contenido...'
                ...
                <div className='space-y-3 p-3 sm:p-4 bg-gray-50 dark:bg-gray-800/50 rounded-lg'>
                  <div className='flex items-center gap-2'>
                    ...
                    <span className='text-sm font-medium text-gray-700 dark:text-gray-300'>Estilo personalizado</span>
                  </div>

                  <div>
                    <div className='flex items-center justify-between mb-1'>
                      <label className='text-xs sm:text-sm text-gray-600 dark:text-gray-400'>Tamaño</label>
                  ...
                  <div className='grid grid-cols-2 gap-3'>
                    <div>
                      <label className='block text-xs sm:text-sm text-gray-600 dark:text-gray-400 mb-1'>Primer plano</label>
                      <div className='flex items-center gap-2'>
                        <input
                          type='color'
                          value={fgColor}
                    ...
                    <div>
                      <label className='block text-xs sm:text-sm text-gray-600 dark:text-gray-400 mb-1'>Fondo</label>
                      <div className='flex items-center gap-2'>
                        <input
                          type='color'
                          value={bgColor}
              ...
              <div className='space-y-4'>
                <div>
                  ...
                  >
                    {text ? (
                      ...
                      <p className='text-gray-400 text-sm'>Introduce contenido para generar un QR</p>
                    )}
                  </div>
                </div>
                ...
                <div className='p-3 sm:p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg'>
                  <p className='text-xs sm:text-sm text-blue-700 dark:text-blue-300'>
                    💡 Consejo: admite URLs, texto, contactos, etc. Al elegir colores, asegura contraste suficiente entre primer plano y fondo para escanear.
                  </p>
                </div>
              </div>
            </div>
        ...
        <aside className='lg:col-span-3'>
          <div className='card p-4 sm:p-6'>
            ...
            <p className='text-xs sm:text-sm text-gray-600 dark:text-gray-400 mb-3 sm:mb-4'>
              Introduce cualquier contenido para generar un QR. Tamaño y colores personalizados, descarga PNG en un clic.
            </p>
            ...
            <ul className='space-y-2'>
              <li className='flex items-center gap-2 text-xs sm:text-sm text-gray-600 dark:text-gray-400'>
                ...
                Cualquier texto o URL
              </li>
              <li className='flex items-center gap-2 text-xs sm:text-sm text-gray-600 dark:text-gray-400'>
                <span className='w-1.5 h-1.5 rounded-full bg-primary-500' />
                Tamaño personalizado (128–512px)
              </li>
              <li className='flex items-center gap-2 text-xs sm:text-sm text-gray-600 dark:text-gray-400'>
                <span className='w-1.5 h-1.5 rounded-full bg-primary-500' />
                Primer plano / fondo personalizados
              </li>
              <li className='flex items-center gap-2 text-xs sm:text-sm text-gray-600 dark:text-gray-400'>
                <span className='w-1.5 h-1.5 rounded-full bg-primary-500' />
                Descarga PNG en HD
              ...
              <li className='flex items-center gap-2 text-xs sm:text-sm text-gray-600 dark:text-gray-400'>
                <span className='w-1.5 h-1.5 rounded-full bg-primary-500' />
                Generación local, seguridad privada
              </li>
            </ul>
          </div>
        </aside>
