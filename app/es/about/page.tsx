...
const TITLE_SEGMENT = "Sobre nosotros";
const DESC_SEGMENT = "Conoce al equipo de Korelyy y nuestra misión. Seleccionamos más de 900 herramientas gratuitas listas para usar en el navegador, en categorías de IA, imagen, PDF, oficina, desarrollo y creatividad. Disponibles en 6 idiomas en más de 180 países.";
