          ...
          <div className='card p-4 sm:p-6'>
            ...
            >
              ...
              <p className='text-xs sm:text-sm text-gray-500 dark:text-gray-400'>
                يدعم JPG و PNG و WebP و GIF وغيرها
              </p>
            </div>
              ...
              <div className='space-y-4 sm:space-y-6'>
                <div className='grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4'>
                  <div>
                    <div className='flex items-center justify-between mb-2'>
                      <label className='block text-sm font-medium text-gray-700 dark:text-gray-300'>الأصلي</label>
                  ...
                  <div>
                    <div className='flex items-center justify-between mb-2'>
                      <label className='block text-sm font-medium text-gray-700 dark:text-gray-300'>المضغوطة</label>
                ...
                <div className='space-y-3 sm:space-y-4 p-3 sm:p-4 bg-gray-50 dark:bg-gray-800/50 rounded-lg'>
                  <div className='flex items-center gap-2'>
                    ...
                    <span className='text-sm font-medium text-gray-700 dark:text-gray-300'>إعدادات الضغط</span>
                  </div>
                  <div className='grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4'>
                    <div>
                      <div className='flex items-center justify-between mb-1'>
                        <label className='text-xs sm:text-sm text-gray-600 dark:text-gray-400'>الجودة</label>
                    ...
                    <div>
                      <div className='flex items-center justify-between mb-1'>
                        <label className='text-xs sm:text-sm text-gray-600 dark:text-gray-400'>العرض الأقصى</label>
                      ...
                      >
                        ...
                        <option value={4096}>بدون حد (الأصلي)</option>
                      </select>
                    </div>
                  </div>
                </div>
                ...
                <div className='grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4'>
                  ...
                  >
                    {isProcessing ? 'جارٍ الضغط...' : 'بدء الضغط'}
                  </button>
                  <button
        ...
        <aside className='lg:col-span-3'>
          <div className='card p-4 sm:p-6'>
            ...
            <p className='text-xs sm:text-sm text-gray-600 dark:text-gray-400 mb-3 sm:mb-4'>
              اضبط الجودة والحجم بعد رفع الصورة. انقر ضغط لتقليل حجم الملف. معالجة محلية 100٪ بدون رفع.
            </p>
            ...
            <ul className='space-y-2'>
              <li className='flex items-center gap-2 text-xs sm:text-sm text-gray-600 dark:text-gray-400'>
                ...
                محلي فقط، الخصوصية أولاً
              </li>
              <li className='flex items-center gap-2 text-xs sm:text-sm text-gray-600 dark:text-gray-400'>
                <span className='w-1.5 h-1.5 rounded-full bg-primary-500' />
                تحكم في الجودة دفعة واحدة
              </li>
              <li className='flex items-center gap-2 text-xs sm:text-sm text-gray-600 dark:text-gray-400'>
                <span className='w-1.5 h-1.5 rounded-full bg-primary-500' />
                حد أقصى عرض مخصص
