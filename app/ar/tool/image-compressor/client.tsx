    ...
    <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8'>
      <div className='flex flex-wrap items-center gap-1.5 text-xs sm:text-sm mb-6'>
        ...
        {tool && (() => {
          ...
          return (
            <>
              <ChevronLeft className='h-3.5 w-3.5 text-gray-400 shrink-0' />
              <a
        ...
        <aside className='lg:col-span-3'>
          <div className='card p-4 sm:p-6'>
            ...
            <p className='text-xs sm:text-sm text-gray-600 dark:text-gray-400 mb-3 sm:mb-4'>
              رفع الصور، اختر وضع الضغط وصيغة الإخراج، ثم اضغط على ضغط. يتم تنفيذ جميع المعالجات محليًا في متصفحك.
            </p>
