        ...
        <aside className='lg:col-span-3'>
          <div className='card p-4 sm:p-6'>
            ...
            <p className='text-xs sm:text-sm text-gray-600 dark:text-gray-400 mb-3 sm:mb-4'>
              لصق محتوى المستند، اختر قالب التنسيق، استعرض نتائج التنسيق في الوقت الفعلي، وصدّر إلى Word أو PDF بنقرة واحدة. يدعم المستندات الحكومية، التنسيقات الأكاديمية APA/MLA، التقارير التجارية وقوالب السيرة الذاتية.
            </p>
