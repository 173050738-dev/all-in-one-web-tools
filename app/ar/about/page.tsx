...
const TITLE_SEGMENT = "من نحن";
const DESC_SEGMENT = "تعرف على فريق Korelyy ومهمتنا. نختار أكثر من 900 أداة مجانية جاهزة في المتصفح مع التركيز على الخصوصية، عبر فئات الذكاء الاصطناعي والصور وPDF والمكاتب والتطوير والإبداع. متاح بـ 6 لغات لمستخدمي أكثر من 180 دولة.";
