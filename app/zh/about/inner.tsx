...
export default function AboutPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-2">关于 Korelyy</h1>
      ...
      <div className="prose prose-gray dark:prose-invert max-w-none">
        <section className="mb-8 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 sm:p-8">
          <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">我们是谁</h2>
        ...
        <section className="mb-8">
          <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">我们相信什么</h2>
          <div className="grid sm:grid-cols-2 gap-4">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-5">
              <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">① 100% 免费，零门槛</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400">
                站内所有核心工具均可免费使用，不强制注册、不绑定手机号、不设置「看广告解锁」式付费墙。
              </p>
            </div>
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-5">
              <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">② 隐私优先，用完即焚</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400">
                用户上传的图片、文档、音视频等素材仅用于完成本次操作，1 小时内自动销毁，绝不沉淀为训练数据。
              </p>
            </div>
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-5">
              <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">③ 人工审核，拒绝恶意跳转</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400">
                每一款收录工具都会经过团队人工试用，拒绝捆绑下载、诱导点击、强制跳转第三方页等行为。
              </p>
            </div>
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-5">
              <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">④ 本地化透明合规</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400">
        ...
        <section className="mb-8 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 sm:p-8">
          <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">为什么选择 Korelyy，而不是传统软件下载站</h2>
          <p className="text-gray-600 dark:text-gray-400 mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">联系我们</h2>
          <p className="text-gray-600 dark:text-gray-400 mb-4">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-5 sm:p-6 grid sm:grid-cols-2 gap-4">
            <div>
              <div className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">广告合作 / 商务邮箱</div>
              <div className="text-gray-900 dark:text-gray-100 font-medium">173050738@qq.com</div>
            </div>
            <div>
              <div className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">技术支持 / 隐私维权 / 投诉</div>
              <div className="text-gray-900 dark:text-gray-100 font-medium">173050738@qq.com</div>
            </div>
          </div>
