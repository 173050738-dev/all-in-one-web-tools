  ...
  return (
    <div className='max-w-4xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-4 sm:py-6 lg:py-8'>
      ...
      <div className='prose prose-gray dark:prose-invert max-w-none'>
        ...
        <section className='mb-6 sm:mb-8'>
          <h2 className='text-base sm:text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2.5 sm:mb-3'>一、信息处理主体</h2>
        ...
        <section className='mb-6 sm:mb-8'>
          <h2 className='text-base sm:text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2.5 sm:mb-3'>二、我们收集的信息及使用目的（分两类：必要信息、非必要可选信息）</h2>
          
          <h3 className='text-sm sm:text-base font-semibold text-gray-900 dark:text-gray-100 mb-1.5 sm:mb-2'>（一）为提供工具服务必须收集的必要信息（不收集则无法使用工具）</h3>
          <ul className='list-disc list-inside text-sm sm:text-base text-gray-600 dark:text-gray-400 mb-3 sm:mb-4 space-y-1.5 sm:space-y-2 leading-relaxed'>
          ...
          <h3 className='text-sm sm:text-base font-semibold text-gray-900 dark:text-gray-100 mb-1.5 sm:mb-2'>（二）非必要、可选收集信息（您可自主拒绝，不影响基础工具使用）</h3>
          <ul className='list-disc list-inside text-sm sm:text-base text-gray-600 dark:text-gray-400 mb-3 sm:mb-4 space-y-1.5 sm:space-y-2 leading-relaxed'>
          ...
          <p className='text-sm sm:text-base text-gray-600 dark:text-gray-400 mb-3 sm:mb-4'>
            <strong>明确说明：本站不会主动收集以下敏感个人信息</strong><br/>
            不会强制收集手机号、身份证号、人脸、通讯录、相册定位、银行卡完整卡号、短信记录等敏感信息；仅您主动上传证件图片处理时临时获取图片内容，处理完成立即清除。
          </p>
        </section>

        <section className='mb-6 sm:mb-8'>
          <h2 className='text-base sm:text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2.5 sm:mb-3'>三、信息存储、清理与数据出境规则</h2>
          <ul className='list-disc list-inside text-sm sm:text-base text-gray-600 dark:text-gray-400 mb-3 sm:mb-4 space-y-1.5 sm:space-y-2 leading-relaxed'>
            <li><strong>存储地域</strong>：所有用户数据、访问日志、临时文件均存储于中国大陆合规服务器。</li>
            <li><strong>存储时限</strong>：
              <ul className='text-sm sm:text-base list-disc list-inside ml-4 mt-2 leading-relaxed'>
        ...
        <section className='mb-6 sm:mb-8'>
          <h2 className='text-base sm:text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2.5 sm:mb-3'>四、第三方共享信息情形（仅以下合法场景可共享，无其他出售/倒卖行为）</h2>
          <p className='text-sm sm:text-base text-gray-600 dark:text-gray-400 mb-3 sm:mb-4'>
        ...
        <section className='mb-6 sm:mb-8'>
          <h2 className='text-base sm:text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2.5 sm:mb-3'>五、您享有的个人信息法定权利</h2>
          <p className='text-sm sm:text-base text-gray-600 dark:text-gray-400 mb-3 sm:mb-4'>
        ...
        <section className='mb-6 sm:mb-8'>
          <h2 className='text-base sm:text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2.5 sm:mb-3'>六、数据安全保护措施</h2>
          <ul className='list-disc list-inside text-sm sm:text-base text-gray-600 dark:text-gray-400 mb-3 sm:mb-4 space-y-1.5 sm:space-y-2 leading-relaxed'>
        ...
        <section className='mb-6 sm:mb-8'>
          <h2 className='text-base sm:text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2.5 sm:mb-3'>七、未成年人信息保护</h2>
          <p className='text-sm sm:text-base text-gray-600 dark:text-gray-400 mb-3 sm:mb-4'>
        ...
        <section className='mb-6 sm:mb-8'>
          <h2 className='text-base sm:text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2.5 sm:mb-3'>八、Cookie使用说明</h2>
          <p className='text-sm sm:text-base text-gray-600 dark:text-gray-400 mb-3 sm:mb-4'>
            本站使用两类Cookie：功能性Cookie（维持登录、工具会话，必须启用）；广告统计Cookie（可选，用于个性化推广）。
          </p>
          <p className='text-sm sm:text-base text-gray-600 dark:text-gray-400 mb-3 sm:mb-4'>
        ...
        <section className='mb-6 sm:mb-8'>
          <h2 className='text-base sm:text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2.5 sm:mb-3'>九、政策更新与通知</h2>
          <p className='text-sm sm:text-base text-gray-600 dark:text-gray-400 mb-3 sm:mb-4'>
        ...
        <section className='mb-6 sm:mb-8'>
          <h2 className='text-base sm:text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2.5 sm:mb-3'>十、投诉渠道</h2>
          <ul className='list-disc list-inside text-sm sm:text-base text-gray-600 dark:text-gray-400 mb-3 sm:mb-4 space-y-1.5 sm:space-y-2 leading-relaxed'>
