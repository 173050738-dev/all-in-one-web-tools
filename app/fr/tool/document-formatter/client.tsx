        ...
        <aside className='lg:col-span-3'>
          <div className='card p-4 sm:p-6'>
            ...
            <p className='text-xs sm:text-sm text-gray-600 dark:text-gray-400 mb-3 sm:mb-4'>
              Collez le contenu du document, sélectionnez un modèle de format, prévisualisez la mise en page en temps réel et exportez vers Word ou PDF en un clic. Prend en charge les documents gouvernementaux, les formats académiques APA/MLA, les rapports d&#x27;entreprise et les modèles de CV.
            </p>
            ...
            <ul className='space-y-2'>
              ...
              <li className='flex items-center gap-2 text-xs sm:text-sm text-gray-600 dark:text-gray-400'>
                <span className='w-1.5 h-1.5 rounded-full bg-primary-500' />
                Traitement 100% Coté Navigateur
              </li>
            </ul>
          </div>
        </aside>
