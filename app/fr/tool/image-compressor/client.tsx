          ...
          <div className='card p-4 sm:p-6'>
            ...
            >
              ...
              <p className='text-sm sm:text-base text-gray-700 dark:text-gray-300 font-medium mb-1'>
                Cliquez ou déposez pour téléverser une image
              </p>
              <p className='text-xs sm:text-sm text-gray-500 dark:text-gray-400'>
                Prend en charge JPG, PNG, WebP, GIF et plus
              </p>
            </div>
              ...
              <div className='space-y-4 sm:space-y-6'>
                <div className='grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4'>
                  <div>
                    <div className='flex items-center justify-between mb-2'>
                      <label className='block text-sm font-medium text-gray-700 dark:text-gray-300'>Original</label>
                  ...
                  <div>
                    <div className='flex items-center justify-between mb-2'>
                      <label className='block text-sm font-medium text-gray-700 dark:text-gray-300'>Compressée</label>
                    ...
                    <div className='rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden bg-gray-50 dark:bg-gray-800'>
                      {compressedImage ? (
                        ...
                        <div className='w-full h-40 sm:h-48 flex items-center justify-center text-gray-400 text-sm'>
                          Cliquez pour lancer la compression
                        </div>
                      )}
                    </div>
                  </div>
                ...
                <div className='space-y-3 sm:space-y-4 p-3 sm:p-4 bg-gray-50 dark:bg-gray-800/50 rounded-lg'>
                  <div className='flex items-center gap-2'>
                    ...
                    <span className='text-sm font-medium text-gray-700 dark:text-gray-300'>Paramètres de compression</span>
                  </div>
                  <div className='grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4'>
                    <div>
                      <div className='flex items-center justify-between mb-1'>
                        <label className='text-xs sm:text-sm text-gray-600 dark:text-gray-400'>Qualité</label>
                    ...
                    <div>
                      <div className='flex items-center justify-between mb-1'>
                        <label className='text-xs sm:text-sm text-gray-600 dark:text-gray-400'>Largeur max</label>
                      ...
                      >
                        ...
                        <option value={4096}>Illimité (original)</option>
                      </select>
                    </div>
                  </div>
                </div>
                ...
                <div className='grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4'>
                  ...
                  >
                    {isProcessing ? 'Compression en cours...' : 'Démarrer la compression'}
                  </button>
                  <button
        ...
        <aside className='lg:col-span-3'>
          <div className='card p-4 sm:p-6'>
            ...
            <p className='text-xs sm:text-sm text-gray-600 dark:text-gray-400 mb-3 sm:mb-4'>
              Ajustez qualité et taille après téléversement. Cliquez sur compresser pour réduire la taille. Traitement 100% local, aucun envoi.
            </p>
            ...
            <ul className='space-y-2'>
              <li className='flex items-center gap-2 text-xs sm:text-sm text-gray-600 dark:text-gray-400'>
                ...
                Local uniquement, confidentialité d'abord
              </li>
              <li className='flex items-center gap-2 text-xs sm:text-sm text-gray-600 dark:text-gray-400'>
                <span className='w-1.5 h-1.5 rounded-full bg-primary-500' />
              ...
              <li className='flex items-center gap-2 text-xs sm:text-sm text-gray-600 dark:text-gray-400'>
                <span className='w-1.5 h-1.5 rounded-full bg-primary-500' />
                Limite de largeur max personnalisée
              </li>
              <li className='flex items-center gap-2 text-xs sm:text-sm text-gray-600 dark:text-gray-400'>
                <span className='w-1.5 h-1.5 rounded-full bg-primary-500' />
