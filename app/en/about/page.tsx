...
const TITLE_SEGMENT = "About Us";
const DESC_SEGMENT = "Meet the Korelyy team and our mission. We curate 900+ browser-ready, privacy-first free tools across AI, image, PDF, office, developer and creative categories. Available in 6 languages to users in 180+ countries.";
