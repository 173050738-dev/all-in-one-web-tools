export default function DisclaimerPage() {
  return (
    <div className='max-w-4xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-4 sm:py-6 lg:py-8'>
      <h1 className='text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 dark:text-gray-100 mb-1 sm:mb-2'>Data Processing Rules & Disclaimer</h1>
      <p className='text-[11px] sm:text-xs text-gray-500 dark:text-gray-400 mb-4 sm:mb-5'>Version: V1.0 | Last Updated: June 23, 2026</p>
      ...
      <div className='prose prose-gray dark:prose-invert max-w-none'>
        <section className='mb-6 sm:mb-8 bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 sm:p-5 border border-blue-200 dark:border-blue-800'>
          <h2 className='text-base sm:text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2.5 sm:mb-3'>Preface</h2>
        ...
        <section className='mb-6 sm:mb-8'>
          <h2 className='text-base sm:text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2.5 sm:mb-3'>1. Data Processing Rules</h2>
          <p className='text-sm sm:text-base text-gray-600 dark:text-gray-400 mb-3 sm:mb-4'>
          ...
          <h3 className='text-sm sm:text-base font-semibold text-gray-900 dark:text-gray-100 mb-1.5 sm:mb-2'>1.1 Local Processing Priority</h3>
          <ul className='text-sm sm:text-base list-disc list-inside text-gray-600 dark:text-gray-400 mb-3 sm:mb-4 space-y-1.5 sm:space-y-2 leading-relaxed'>
          ...
          <h3 className='text-sm sm:text-base font-semibold text-gray-900 dark:text-gray-100 mb-1.5 sm:mb-2'>1.2 Immediate Deletion Principle (Only for Tools Requiring Server Processing)</h3>
          <ul className='text-sm sm:text-base list-disc list-inside text-gray-600 dark:text-gray-400 mb-3 sm:mb-4 space-y-1.5 sm:space-y-2 leading-relaxed'>
          ...
          <h3 className='text-sm sm:text-base font-semibold text-gray-900 dark:text-gray-100 mb-1.5 sm:mb-2'>1.3 Minimal Collection Principle</h3>
          <ul className='text-sm sm:text-base list-disc list-inside text-gray-600 dark:text-gray-400 mb-3 sm:mb-4 space-y-1.5 sm:space-y-2 leading-relaxed'>
          ...
          <h3 className='text-sm sm:text-base font-semibold text-gray-900 dark:text-gray-100 mb-1.5 sm:mb-2'>1.4 Transparent Processing Principle</h3>
          <ul className='text-sm sm:text-base list-disc list-inside text-gray-600 dark:text-gray-400 mb-3 sm:mb-4 space-y-1.5 sm:space-y-2 leading-relaxed'>
          ...
          <h3 className='text-sm sm:text-base font-semibold text-gray-900 dark:text-gray-100 mb-1.5 sm:mb-2'>1.5 Special Statement on AI Tools</h3>
          <ul className='text-sm sm:text-base list-disc list-inside text-gray-600 dark:text-gray-400 mb-3 sm:mb-4 space-y-1.5 sm:space-y-2 leading-relaxed'>
        ...
        <section className='mb-6 sm:mb-8'>
          <h2 className='text-base sm:text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2.5 sm:mb-3'>2. Service Disclaimer</h2>
          <p className='text-sm sm:text-base text-gray-600 dark:text-gray-400 mb-3 sm:mb-4'>
        ...
        <section className='mb-6 sm:mb-8'>
          <h2 className='text-base sm:text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2.5 sm:mb-3'>3. User Conduct Standards and Prohibited Behaviors</h2>
          <p className='text-sm sm:text-base text-gray-600 dark:text-gray-400 mb-3 sm:mb-4'>
            As a user, you promise and agree to strictly abide by the following conduct standards:
          </p>

          <h3 className='text-sm sm:text-base font-semibold text-gray-900 dark:text-gray-100 mb-1.5 sm:mb-2'>3.1 User Responsibilities</h3>
          <ul className='text-sm sm:text-base list-disc list-inside text-gray-600 dark:text-gray-400 mb-3 sm:mb-4 space-y-1.5 sm:space-y-2 leading-relaxed'>
          ...
          <h3 className='text-sm sm:text-base font-semibold text-gray-900 dark:text-gray-100 mb-1.5 sm:mb-2'>3.2 Absolutely Prohibited Behaviors (Violations will result in immediate account shutdown, IP blocking, and retention of right to pursue legal action)</h3>
          <ul className='text-sm sm:text-base list-disc list-inside text-gray-600 dark:text-gray-400 mb-3 sm:mb-4 space-y-1.5 sm:space-y-2 leading-relaxed'>
        ...
        <section className='mb-6 sm:mb-8'>
          <h2 className='text-base sm:text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2.5 sm:mb-3'>4. Intellectual Property Statement</h2>
          <ul className='text-sm sm:text-base list-disc list-inside text-gray-600 dark:text-gray-400 mb-3 sm:mb-4 space-y-1.5 sm:space-y-2 leading-relaxed'>
        ...
        <section className='mb-6 sm:mb-8'>
          <h2 className='text-base sm:text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2.5 sm:mb-3'>5. Limitation of Liability</h2>
          <p className='text-sm sm:text-base text-gray-600 dark:text-gray-400 mb-3 sm:mb-4'>
        ...
        <section className='mb-6 sm:mb-8'>
          <h2 className='text-base sm:text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2.5 sm:mb-3'>6. Minors Protection</h2>
          <ul className='text-sm sm:text-base list-disc list-inside text-gray-600 dark:text-gray-400 mb-3 sm:mb-4 space-y-1.5 sm:space-y-2 leading-relaxed'>
        ...
        <section className='mb-6 sm:mb-8'>
          <h2 className='text-base sm:text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2.5 sm:mb-3'>7. Terms Changes</h2>
          <ul className='text-sm sm:text-base list-disc list-inside text-gray-600 dark:text-gray-400 mb-3 sm:mb-4 space-y-1.5 sm:space-y-2 leading-relaxed'>
        ...
        <section className='mb-6 sm:mb-8'>
          <h2 className='text-base sm:text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2.5 sm:mb-3'>8. Applicable Law and Dispute Resolution</h2>
          <ul className='text-sm sm:text-base list-disc list-inside text-gray-600 dark:text-gray-400 mb-3 sm:mb-4 space-y-1.5 sm:space-y-2 leading-relaxed'>
        ...
        <section className='mb-6 sm:mb-8'>
          <h2 className='text-base sm:text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2.5 sm:mb-3'>9. Contact Information</h2>
          <p className='text-sm sm:text-base text-gray-600 dark:text-gray-400 mb-3 sm:mb-4'>
