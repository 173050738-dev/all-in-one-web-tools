            ...
            {originalImage && (
              <div className='space-y-4 sm:space-y-6'>
                <div className='grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4'>
                  ...
                  <div>
                    <div className='flex items-center justify-between mb-2'>
                      <label className='block text-sm font-medium text-gray-700 dark:text-gray-300'>Compressed</label>
                ...
                <div className='space-y-3 sm:space-y-4 p-3 sm:p-4 bg-gray-50 dark:bg-gray-800/50 rounded-lg'>
                  <div className='flex items-center gap-2'>
                    ...
                    <span className='text-sm font-medium text-gray-700 dark:text-gray-300'>Compression settings</span>
                  </div>
                  <div className='grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4'>
                    <div>
                      <div className='flex items-center justify-between mb-1'>
                        <label className='text-xs sm:text-sm text-gray-600 dark:text-gray-400'>Quality</label>
                    ...
                    <div>
                      <div className='flex items-center justify-between mb-1'>
                        <label className='text-xs sm:text-sm text-gray-600 dark:text-gray-400'>Max width</label>
                      ...
                      >
                        ...
                        <option value={4096}>Unlimited (original)</option>
                      </select>
                    </div>
                  </div>
                </div>
        ...
        <aside className='lg:col-span-3'>
          <div className='card p-4 sm:p-6'>
            ...
            <p className='text-xs sm:text-sm text-gray-600 dark:text-gray-400 mb-3 sm:mb-4'>
              Adjust compression quality and size after uploading an image. Click compress to quickly reduce file size. 100% local processing, no uploads.
            </p>
