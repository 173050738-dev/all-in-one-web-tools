        ...
        <aside className='lg:col-span-3'>
          <div className='card p-4 sm:p-6'>
            ...
            <p className='text-xs sm:text-sm text-gray-600 dark:text-gray-400 mb-3 sm:mb-4'>
              Paste document content, select a format template, preview the layout in real-time, and export to Word or PDF with one click. Supports government documents, APA/MLA academic formats, business reports, and resume templates.
            </p>
