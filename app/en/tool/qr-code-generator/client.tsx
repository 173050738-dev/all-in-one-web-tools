        ...
        <main className='lg:col-span-7'>
          <div className='card p-4 sm:p-6'>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6'>
              <div className='space-y-4'>
                <div>
                  <label className='block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2'>QR Content</label>
                  <textarea
                    value={text}
                ...
                <div className='space-y-3 p-3 sm:p-4 bg-gray-50 dark:bg-gray-800/50 rounded-lg'>
                  <div className='flex items-center gap-2'>
                    ...
                    <span className='text-sm font-medium text-gray-700 dark:text-gray-300'>Custom styling</span>
                  </div>

                  <div>
                    <div className='flex items-center justify-between mb-1'>
                      <label className='text-xs sm:text-sm text-gray-600 dark:text-gray-400'>Size</label>
                  ...
                  <div className='grid grid-cols-2 gap-3'>
                    <div>
                      <label className='block text-xs sm:text-sm text-gray-600 dark:text-gray-400 mb-1'>Foreground</label>
                      <div className='flex items-center gap-2'>
                        <input
                          type='color'
                          value={fgColor}
                    ...
                    <div>
                      <label className='block text-xs sm:text-sm text-gray-600 dark:text-gray-400 mb-1'>Background</label>
                      <div className='flex items-center gap-2'>
                        <input
                          type='color'
                          value={bgColor}
              ...
              <div className='space-y-4'>
                <div>
                  ...
                  >
                    {text ? (
                      ...
                      <p className='text-gray-400 text-sm'>Enter content to generate a QR code</p>
                    )}
                  </div>
                </div>
                ...
                <div className='p-3 sm:p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg'>
                  <p className='text-xs sm:text-sm text-blue-700 dark:text-blue-300'>
                    💡 Tip: supports URLs, text, contact info and more. When picking colors, ensure enough foreground/background contrast for reliable scanning.
                  </p>
                </div>
              </div>
            </div>
        ...
        <aside className='lg:col-span-3'>
          <div className='card p-4 sm:p-6'>
            ...
            <p className='text-xs sm:text-sm text-gray-600 dark:text-gray-400 mb-3 sm:mb-4'>
              Enter any content to generate a QR code. Custom size & colors, one-click PNG download.
            </p>
