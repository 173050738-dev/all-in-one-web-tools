                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="font-medium text-sm sm:text-base text-gray-900 dark:text-gray-100 truncate">{'hi' === 'zh' ? tool.name : (((tool as any).nameEn ?? '') || tool.name)}</p>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-4 sm:p-6">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-bold text-gray-900 dark:text-gray-100">{'hi' === 'zh' ? selectedToolData.name : (((selectedToolData as any).nameEn ?? '') || selectedToolData.name)}</h3>
