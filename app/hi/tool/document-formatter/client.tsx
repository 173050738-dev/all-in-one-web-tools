...
const pathLocale = (() => {
  ...
  const rawLocale = (lm && lm[1]) ? lm[1] : ''; return VALID_LOCALES.includes(rawLocale) ? rawLocale : (resolvedParams?.locale || 'hi');
})();
    ...
    <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-6 lg:gap-8'>
        ...
        <main className='lg:col-span-7'>
          <DocumentFormatter locale={resolvedLocale} />
        </main>
        <aside className='lg:col-span-3'>
          <div className='card p-4 sm:p-6'>
            <h3 className='font-semibold text-gray-900 dark:text-gray-100 mb-3 sm:mb-4'>{t('guide')}</h3>
            <p className='text-xs sm:text-sm text-gray-600 dark:text-gray-400 mb-3 sm:mb-4'>
              दस्तावेज़ की सामग्री चिपकाएँ, प्रारूप टेम्प्लेट चुनें, वास्तविक समय में प्रारूपण प्रभाव पूर्वावलोकन करें, और एक क्लिक से Word या PDF में निर्यात करें। सरकारी दस्तावेज़, APA/MLA शैक्षणिक प्रारूप, व्यावसायिक रिपोर्ट और रिज्यूमे टेम्प्लेट का समर्थन करता है।
            </p>
            ...
            <ul className='space-y-2'>
              ...
              <li className='flex items-center gap-2 text-xs sm:text-sm text-gray-600 dark:text-gray-400'>
                <span className='w-1.5 h-1.5 rounded-full bg-primary-500' />
                Word/PDF में निर्यात
              </li>
              <li className='flex items-center gap-2 text-xs sm:text-sm text-gray-600 dark:text-gray-400'>
                <span className='w-1.5 h-1.5 rounded-full bg-primary-500' />
                हेडिंग्स H1-H6 का स्वचालित पता लगाना
              </li>
              <li className='flex items-center gap-2 text-xs sm:text-sm text-gray-600 dark:text-gray-400'>
                <span className='w-1.5 h-1.5 rounded-full bg-primary-500' />
                100% ब्राउज़र-साइड प्रसंस्करण
              </li>
            </ul>
          </div>
        </aside>
