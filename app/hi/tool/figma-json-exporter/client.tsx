        ...
        <aside className='lg:col-span-3'>
          <div className='card p-4 sm:p-6'>
            ...
            <p className='text-xs sm:text-sm text-gray-600 dark:text-gray-400 mb-3 sm:mb-4'>
              Figma में पेज पर राइट-क्लिक → कॉपी → टूल में पेस्ट करें, एक्सपोर्ट करने के लिए लेयर्स चुनें। PNG और SVG प्रारूपों का समर्थन करता है, ब्राउज़र में पूर्ण रूप से स्थानीय प्रसंस्करण।
            </p>
            ...
            <ul className='space-y-2'>
              ...
              <li className='flex items-center gap-2 text-xs sm:text-sm text-gray-600 dark:text-gray-400'>
                <span className='w-1.5 h-1.5 rounded-full bg-primary-500' />
                बैच एक्सपोर्ट PNG/SVG
              </li>
              <li className='flex items-center gap-2 text-xs sm:text-sm text-gray-600 dark:text-gray-400'>
                <span className='w-1.5 h-1.5 rounded-full bg-primary-500' />
                फिग्मा लेयर स्ट्रक्चर को पार्स करें
              </li>
              <li className='flex items-center gap-2 text-xs sm:text-sm text-gray-600 dark:text-gray-400'>
                <span className='w-1.5 h-1.5 rounded-full bg-primary-500' />
                सब चुनें/व्यक्तिगत लेयर्स
              </li>
              <li className='flex items-center gap-2 text-xs sm:text-sm text-gray-600 dark:text-gray-400'>
                <span className='w-1.5 h-1.5 rounded-full bg-primary-500' />
                फिग्मा खाता की आवश्यकता नहीं
              </li>
            </ul>
          </div>
        </aside>
