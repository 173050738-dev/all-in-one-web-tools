        ...
        <main className='lg:col-span-7'>
          <div className='card p-4 sm:p-6'>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6'>
              <div className='space-y-4'>
                <div>
                  <label className='block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2'>QR सामग्री</label>
                  <textarea
                    value={text}
                    onChange={(e) => setText(e.target.value)}
                    placeholder='URL, टेक्स्ट या कोई सामग्री डालें...'
                ...
                <div className='space-y-3 p-3 sm:p-4 bg-gray-50 dark:bg-gray-800/50 rounded-lg'>
                  <div className='flex items-center gap-2'>
                    ...
                    <span className='text-sm font-medium text-gray-700 dark:text-gray-300'>कस्टम स्टाइल</span>
                  </div>

                  <div>
                    <div className='flex items-center justify-between mb-1'>
                      <label className='text-xs sm:text-sm text-gray-600 dark:text-gray-400'>आकार</label>
                  ...
                  <div className='grid grid-cols-2 gap-3'>
                    <div>
                      <label className='block text-xs sm:text-sm text-gray-600 dark:text-gray-400 mb-1'>अग्रभाग</label>
                      <div className='flex items-center gap-2'>
                        <input
                          type='color'
                          value={fgColor}
                    ...
                    <div>
                      <label className='block text-xs sm:text-sm text-gray-600 dark:text-gray-400 mb-1'>पृष्ठभूमि</label>
                      <div className='flex items-center gap-2'>
                        <input
                          type='color'
                          value={bgColor}
              ...
              <div className='space-y-4'>
                <div>
                  <label className='block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2'>पूर्वावलोकन</label>
                  <div
                    ref={qrRef}
                  ...
                  >
                    {text ? (
                      ...
                      <p className='text-gray-400 text-sm'>QR कोड बनाने के लिए सामग्री डालें</p>
                    )}
                  </div>
                </div>
                ...
                <div className='grid grid-cols-2 gap-3'>
                  ...
                  >
                    ...
                    {copied ? 'कॉपी हो गया' : 'छवि कॉपी करें'}
                  </button>
                </div>

                <div className='p-3 sm:p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg'>
                  <p className='text-xs sm:text-sm text-blue-700 dark:text-blue-300'>
                    💡 सुझाव: URL, टेक्स्ट, संपर्क आदि कोई भी सामग्री डालें। स्कैन होने के लिए अग्रभाग और पृष्ठभूमि रंगों का पर्याप्त व्यतिक्रम सुनिश्चित करें।
                  </p>
                </div>
              </div>
            </div>
        ...
        <aside className='lg:col-span-3'>
          <div className='card p-4 sm:p-6'>
            ...
            <p className='text-xs sm:text-sm text-gray-600 dark:text-gray-400 mb-3 sm:mb-4'>
              QR कोड बनाने के लिए कोई भी सामग्री डालें। कस्टम आकार और रंग, एक क्लिक में PNG डाउनलोड।
            </p>
            ...
            <ul className='space-y-2'>
              ...
              <li className='flex items-center gap-2 text-xs sm:text-sm text-gray-600 dark:text-gray-400'>
                <span className='w-1.5 h-1.5 rounded-full bg-primary-500' />
                कस्टम आकार (128-512px)
              </li>
              <li className='flex items-center gap-2 text-xs sm:text-sm text-gray-600 dark:text-gray-400'>
                <span className='w-1.5 h-1.5 rounded-full bg-primary-500' />
                कस्टम अग्रभाग/पृष्ठभूमि
              </li>
              <li className='flex items-center gap-2 text-xs sm:text-sm text-gray-600 dark:text-gray-400'>
                <span className='w-1.5 h-1.5 rounded-full bg-primary-500' />
                HD PNG डाउनलोड
              ...
              <li className='flex items-center gap-2 text-xs sm:text-sm text-gray-600 dark:text-gray-400'>
                <span className='w-1.5 h-1.5 rounded-full bg-primary-500' />
                एक क्लिक में क्लिपबोर्ड पर कॉपी
              </li>
              <li className='flex items-center gap-2 text-xs sm:text-sm text-gray-600 dark:text-gray-400'>
                <span className='w-1.5 h-1.5 rounded-full bg-primary-500' />
                स्थानीय निर्माण, गोपनीयता सुरक्षित
              </li>
            </ul>
          </div>
        </aside>
