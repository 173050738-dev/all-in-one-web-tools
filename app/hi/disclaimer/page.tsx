export default function DisclaimerPage() {
  return (
    <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8'>
      <h1 className='text-3xl font-bold text-gray-900 dark:text-gray-100 mb-2'>数据处理规则及免责声明</h1>
      <p className='text-sm text-gray-500 dark:text-gray-400 mb-8'>版本号：V1.0｜最后更新：2026年6月23日</p>
      ...
      <div className='prose prose-gray dark:prose-invert max-w-none'>
        ...
        <section className='mb-8'>
          <h2 className='text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4'>一、数据处理规则</h2>
          <p className='text-gray-600 dark:text-gray-400 mb-4'>
            我们严格遵循《个人信息保护法》《网络安全法》《数据安全法》《消费者权益保护法》等法律法规本站所有工具遵循以下数据处理原则：
          </p>

          <h3 className='text-lg font-semibold text-gray-900 dark:text-gray-100 mb-3'>（一）本地处理优先</h3>
          ...
          <h3 className='text-lg font-semibold text-gray-900 dark:text-gray-100 mb-3'>（二）即时删除原则（仅针对需服务器处理的工具）</h3>
          <ul className='list-disc list-inside text-gray-600 dark:text-gray-400 mb-4 space-y-2'>
          ...
          <h3 className='text-lg font-semibold text-gray-900 dark:text-gray-100 mb-3'>（三）最小化收集原则</h3>
          <ul className='list-disc list-inside text-gray-600 dark:text-gray-400 mb-4 space-y-2'>
          ...
          <h3 className='text-lg font-semibold text-gray-900 dark:text-gray-100 mb-3'>（四）透明处理原则</h3>
          <ul className='list-disc list-inside text-gray-600 dark:text-gray-400 mb-4 space-y-2'>
          ...
          <h3 className='text-lg font-semibold text-gray-900 dark:text-gray-100 mb-3'>（五）AI 工具特别说明</h3>
          <ul className='list-disc list-inside text-gray-600 dark:text-gray-400 mb-4 space-y-2'>
            <li>本站收录的 AI 工具仅为外部链接跳转，不直接提供生成式 AI 服务；</li>
            <li>如第三方 AI 工具面向国内用户提供服务，须自行完成《生成式人工智能服务管理暂行办法》规定的算法备案；</li>
            <li>用户使用第三方 AI 工具时，须遵守该工具的使用协议、隐私政策本站不为第三方 AI 工具的行为承担法律责任；</li>
        ...
        <section className='mb-8'>
          <h2 className='text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4'>二、服务免责声明</h2>
          <p className='text-gray-600 dark:text-gray-400 mb-4'>
            使用本网站服务时，请注意以下免责条款本站按"现状、可用"原则提供服务：
          </p>
          <ul className='list-disc list-inside text-gray-600 dark:text-gray-400 mb-4 space-y-2'>
        ...
        <section className='mb-8'>
          <h2 className='text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4'>三、用户行为规范与禁止行为</h2>
          <p className='text-gray-600 dark:text-gray-400 mb-4'>
            作为用户，您承诺并同意严格遵守以下行为规范：
          </p>

          <h3 className='text-lg font-semibold text-gray-900 dark:text-gray-100 mb-3'>（一）用户责任</h3>
          <ul className='list-disc list-inside text-gray-600 dark:text-gray-400 mb-4 space-y-2'>
          ...
          <h3 className='text-lg font-semibold text-gray-900 dark:text-gray-100 mb-3'>（二）绝对禁止行为（违反将立即关停账号、封禁 IP、保留追责权利）</h3>
          <ul className='list-disc list-inside text-gray-600 dark:text-gray-400 mb-4 space-y-2'>
        ...
        <section className='mb-8'>
          <h2 className='text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4'>四、知识产权声明</h2>
          <ul className='list-disc list-inside text-gray-600 dark:text-gray-400 mb-4 space-y-2'>
            ...
            <li>第三方开源组件、字体、素材由对应权利人持有知识产权本站已获得合法授权使用。</li>
          </ul>
        </section>

        <section className='mb-8'>
          <h2 className='text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4'>五、责任限制</h2>
          <p className='text-gray-600 dark:text-gray-400 mb-4'>
            在法律允许的最大范围内：
          </p>
          <ul className='list-disc list-inside text-gray-600 dark:text-gray-400 mb-4 space-y-2'>
            <li>本站对您承担的全部责任总额，不超过您在过去 12 个月内实际支付给本站的服务费用（如有）；如您未支付任何费用本站对您的责任总额不超过人民币 100 元；</li>
            <li>本站不对任何间接、附带、特殊、惩罚性或后果性损害承担责任，包括但不限于利润损失、商誉损失、数据丢失、业务中断、预期利益损失等；</li>
            <li>本站对您提供的工具链接、第三方服务的可用性、安全性、准确性不承担保证责任；</li>
            <li>因不可抗力（包括但不限于地震、洪水、台风、疫情、政策变化、监管要求、网络攻击、运营商中断、第三方服务故障等）导致本站无法履行义务的本站不承担违约责任；</li>
        ...
        <section className='mb-8'>
          <h2 className='text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4'>六、未成年人保护</h2>
          <ul className='list-disc list-inside text-gray-600 dark:text-gray-400 mb-4 space-y-2'>
            <li>本站服务主要面向具备完全民事行为能力的成年人（年满 18 周岁）；</li>
            <li>未成年人使用本站服务必须经法定监护人同意并全程监护；监护人对未成年人使用本站服务的一切行为及后果承担全部责任；</li>
            <li>本站不主动收集未成年人信息；如监护人发现未成年人在未经同意的情况下上传了个人信息或隐私文件，可通过 173050738@qq.com 申请立即删除本站将在 24 小时内核实清理；</li>
            <li>如本站发现未经监护人同意收集了未成年人个人信息，将主动删除相关数据。</li>
          </ul>
        </section>

        <section className='mb-8'>
          <h2 className='text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4'>七、条款变更</h2>
          <ul className='list-disc list-inside text-gray-600 dark:text-gray-400 mb-4 space-y-2'>
        ...
        <section className='mb-8'>
          <h2 className='text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4'>八、适用法律与争议解决</h2>
          <ul className='list-disc list-inside text-gray-600 dark:text-gray-400 mb-4 space-y-2'>
        ...
        <section className='mb-8'>
          <h2 className='text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4'>九、联系方式</h2>
          <p className='text-gray-600 dark:text-gray-400 mb-4'>
