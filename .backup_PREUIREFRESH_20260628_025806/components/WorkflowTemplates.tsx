...
const categoryInfo: Record<string, { icon: any; color: string }> = {
  'content-creator': { icon: Megaphone, color: 'from-pink-500 to-rose-500' },
  'designer': { icon: Palette, color: 'from-purple-500 to-indigo-500' },
  'developer': { icon: Code, color: 'from-blue-500 to-cyan-500' },
  'office-worker': { icon: Briefcase, color: 'from-green-500 to-emerald-500' },
  'student': { icon: GraduationCap, color: 'from-yellow-500 to-orange-500' },
  'video-creator': { icon: Film, color: 'from-red-500 to-pink-500' },
};
