...
const TOOL_FAQ_I18N: Record<string, Record<SeoLocale, Array<{ q: string; a: string }>>> = {
  ...
  'ai-game-guide': {
    en: [
      { q: 'What games does the AI guide support?', a: 'It covers popular titles across PC, mobile and console — RPGs, FPS, MOBA, puzzle and more. Enter the game name and your blocker for tailored strategies.' },
      { q: 'Can it help with a specific boss or level?', a: 'Yes. Describe the boss/level and what you tried. The AI builds 3 different strategies with step-by-step tactics and pitfalls to avoid.' },
      { q: 'Are the guides accurate?', a: 'The AI draws on publicly known game mechanics. It won\'t invent skills or items that don\'t exist, but always double-check against current patch notes.' },
      { q: 'Which platforms are supported?', a: 'You can pick PC, Mobile, Console or General. The advice adapts to platform-specific controls and meta where relevant.' },
      { q: 'Is it free?', a: 'Yes, 5 free generations per day per IP, no signup required.' },
    ],
    zh: [
      { q: 'AI攻略支持哪些游戏？', a: '覆盖 PC、手机、主机的热门游戏，包括 RPG、FPS、MOBA、解谜等。输入游戏名和卡点即可获得定制攻略。' },
      { q: '能帮我打特定BOSS或关卡吗？', a: '可以。描述BOSS/关卡和你试过的方法，AI 会生成3条不同思路的攻略，含分步战术和避坑要点。' },
      { q: '攻略准确吗？', a: 'AI 基于公开的游戏机制生成，不会编造不存在的技能或道具，但建议对照当前版本公告二次确认。' },
      { q: '支持哪些平台？', a: '可选 PC、手机、主机或通用，攻略会根据平台操作和版本环境适配。' },
      { q: '免费吗？', a: '免费，每个 IP 每天 5 次，无需注册。' },
    ],
    es: [
      { q: '¿Qué juegos admite la guía IA?', a: 'Cubre títulos populares de PC, móvil y consola — RPG, FPS, MOBA, puzles y más. Ingresa el juego y tu problema para estrategias personalizadas.' },
      { q: '¿Puede ayudar con un jefe o nivel específico?', a: 'Sí. Describe el jefe/nivel y lo que intentaste. La IA crea 3 estrategias diferentes con tácticas paso a paso y errores a evitar.' },
      { q: '¿Las guías son precisas?', a: 'La IA se basa en mecánicas conocidas del juego. No inventa habilidades o objetos que no existen, pero verifica con las notas del parche actual.' },
      { q: '¿Qué plataformas admite?', a: 'Puedes elegir PC, Móvil, Consola o General. El consejo se adapta a los controles y meta de cada plataforma.' },
      { q: '¿Es gratis?', a: 'Sí, 5 generaciones gratis por día por IP, sin registro.' },
    ],
    fr: [
      { q: 'Quels jeux la guide IA prend-elle en charge ?', a: 'Elle couvre les titres populaires sur PC, mobile et console — RPG, FPS, MOBA, puzzles et plus. Entrez le jeu et votre blocage pour des stratégies adaptées.' },
      { q: 'Peut-elle aider avec un boss ou niveau spécifique ?', a: 'Oui. Décrivez le boss/niveau et ce que vous avez essayé. L\'IA crée 3 stratégies différentes avec des tactiques étape par étape et les pièges à éviter.' },
      { q: 'Les guides sont-ils précis ?', a: 'L\'IA s\'appuie sur les mécaniques de jeu connues. Elle n\'invente pas de compétences ou d\'objets inexistants, mais vérifiez toujours les notes de correctif actuelles.' },
      { q: 'Quelles plateformes sont prises en charge ?', a: 'Vous pouvez choisir PC, Mobile, Console ou Général. Les conseils s\'adaptent aux contrôles et au meta de la plateforme.' },
      { q: 'Est-ce gratuit ?', a: 'Oui, 5 générations gratuites par jour par IP, sans inscription.' },
    ],
    hi: [
      { q: 'AI गाइड कौन से गेम समर्थन करता है?', a: 'यह PC, मोबाइल और कंसोल के लोकप्रिय शीर्षकों को कवर करता है — RPG, FPS, MOBA, पज़ल और अधिक। गेम नाम और अपनी समस्या दर्ज करें।' },
      { q: 'क्या यह विशिष्ट बॉस या स्तर में मदद कर सकता है?', a: 'हाँ। बॉस/स्तर का वर्णन करें और आपने क्या प्रयास किया। AI 3 अलग-अलग रणनीतियाँ बनाता है।' },
      { q: 'क्या गाइड सटीक हैं?', a: 'AI ज्ञात गेम यांत्रिकी पर आधारित है। यह गैर-मौजूदा कौशल या वस्तुओं का आविष्कार नहीं करता।' },
      { q: 'कौन से प्लेटफ़ॉर्म समर्थित हैं?', a: 'आप PC, मोबाइल, कंसोल या सामान्य चुन सकते हैं।' },
      { q: 'क्या यह मुफ़्त है?', a: 'हाँ, प्रति IP प्रति दिन 5 मुफ़्त जनरेशन, साइन अप नहीं।' },
    ],
    ar: [
      { q: 'ما الألعاب التي تدعمها أدلة الذكاء الاصطناعي؟', a: 'تغطي الألقاب الشائعة على الكمبيوتر والهاتف ووحدات التحكم — تقمص أدوار، إطلاق نار، MOBA، ألغاز والمزيد.' },
      { q: 'هل يمكنها المساعدة في زعيم أو مستوى معين؟', a: 'نعم. صف الزعيم/المستوى وما جربته. ينشئ الذكاء الاصطناعي 3 استراتيجيات مختلفة.' },
      { q: 'هل الأدلة دقيقة؟', a: 'يعتمد الذكاء الاصطناعي على ميكانيكا اللعبة المعروفة. لا يخترع مهارات أو عناصر غير موجودة.' },
      { q: 'ما المنصات المدعومة؟', a: 'يمكنك اختيار الكمبيوتر أو الهاتف أو وحدة التحكم أو عام.' },
      { q: 'هل هو مجاني؟', a: 'نعم، 5 توليدات مجانية يومياً لكل IP، دون تسجيل.' },
    ],
  },
  'ai-workout-plan': {
    en: [
      { q: 'Is the AI workout plan suitable for beginners?', a: 'Yes. Pick your fitness level (beginner/intermediate/advanced) and the AI tailors exercise selection, volume and intensity to your level.' },
      { q: 'Can I generate a plan without equipment?', a: 'Yes. The bodyweight option creates a full plan using only your body weight — no gym or dumbbells needed.' },
      { q: 'How many days per week can I choose?', a: 'You can pick 2 to 5 days per week. The AI splits muscle groups and rest days accordingly for balanced recovery.' },
      { q: 'Does it include nutrition advice?', a: 'Yes. Each plan comes with general nutrition tips aligned to your goal (fat loss, muscle gain, etc.), though it\'s not a substitute for a registered dietitian.' },
      { q: 'Is it free?', a: 'Yes, 5 free generations per day per IP, no signup required.' },
    ],
    zh: [
      { q: 'AI健身计划适合初学者吗？', a: '适合。选择体能等级（初级/中级/高级），AI 会根据等级调整动作选择、训练量和强度。' },
      { q: '没有器械能生成计划吗？', a: '可以。选择"徒手/自重"，AI 会用纯自重动作生成完整计划，不需要健身房或哑铃。' },
      { q: '每周能选几天训练？', a: '可选 2-5 天。AI 会根据天数分配肌群和休息日，保证恢复平衡。' },
      { q: '有饮食建议吗？', a: '有。每个计划附带针对目标（减脂/增肌等）的通用饮食建议，但不能替代注册营养师。' },
      { q: '免费吗？', a: '免费，每个 IP 每天 5 次，无需注册。' },
    ],
    es: [
      { q: '¿El plan de entrenamiento IA es apto para principiantes?', a: 'Sí. Elige tu nivel (principiante/intermedio/avanzado) y la IA adapta los ejercicios, volumen e intensidad.' },
      { q: '¿Puedo generar un plan sin equipo?', a: 'Sí. La opción de peso corporal crea un plan completo usando solo tu peso corporal, sin gimnasio ni mancuernas.' },
      { q: '¿Cuántos días por semana puedo elegir?', a: 'Puedes elegir de 2 a 5 días. La IA divide los grupos musculares y días de descanso para una recuperación equilibrada.' },
      { q: '¿Incluye consejos de nutrición?', a: 'Sí. Cada plan incluye consejos generales de nutrición según tu objetivo, aunque no sustituye a un nutricionista.' },
      { q: '¿Es gratis?', a: 'Sí, 5 generaciones gratis por día por IP, sin registro.' },
    ],
    fr: [
      { q: 'Le plan d\'entraînement IA convient-il aux débutants ?', a: 'Oui. Choisissez votre niveau (débutant/intermédiaire/avancé) et l\'IA adapte les exercices, le volume et l\'intensité.' },
      { q: 'Puis-je générer un plan sans équipement ?', a: 'Oui. L\'option poids du corps crée un plan complet utilisant uniquement votre poids, sans salle de sport ni haltères.' },
      { q: 'Combien de jours par semaine puis-je choisir ?', a: 'De 2 à 5 jours. L\'IA répartit les groupes musculaires et jours de repos pour une récupération équilibrée.' },
      { q: 'Inclut-il des conseils en nutrition ?', a: 'Oui. Chaque plan inclut des conseils nutritionnels généraux selon votre objectif, sans remplacer un diététicien.' },
      { q: 'Est-ce gratuit ?', a: 'Oui, 5 générations gratuites par jour par IP, sans inscription.' },
    ],
    hi: [
      { q: 'क्या AI वर्कआउट प्लान शुरुआती लोगों के लिए है?', a: 'हाँ। अपना स्तर चुनें और AI व्यायाम, मात्रा और तीव्रता को अनुकूलित करता है।' },
      { q: 'क्या बिना उपकरण के प्लान बन सकता है?', a: 'हाँ। शारीरिक भार विकल्प पूर्ण प्लान बनाता है।' },
      { q: 'मैं प्रति सप्ताह कितने दिन चुन सकता हूं?', a: '2 से 5 दिन चुन सकते हैं।' },
      { q: 'क्या इसमें पोषण सलाह शामिल है?', a: 'हाँ। प्रत्येक प्लान में सामान्य पोषण सुझाव शामिल हैं।' },
      { q: 'क्या यह मुफ़्त है?', a: 'हाँ, प्रति IP प्रति दिन 5 मुफ़्त।' },
    ],
    ar: [
      { q: 'هل خطة التمرين بالذكاء الاصطناعي مناسبة للمبتدئين؟', a: 'نعم. اختر مستواك ويكيّف الذكاء الاصطناعي التمارين والحجم والشدة.' },
      { q: 'هل يمكنني إنشاء خطة بدون معدات؟', a: 'نعم. خيار وزن الجسم ينشئ خطة كاملة باستخدام وزن جسمك فقط.' },
      { q: 'كم يوماً في الأسبوع يمكنني الاختيار؟', a: 'من 2 إلى 5 أيام. يوزّع الذكاء الاصطناعي المجموعات العضلية وأيام الراحة.' },
      { q: 'هل يتضمن نصائح تغذية؟', a: 'نعم. تتضمن كل خطة نصائح تغذية عامة حسب هدفك.' },
      { q: 'هل هو مجاني؟', a: 'نعم، 5 توليدات مجانية يومياً لكل IP.' },
    ],
  },
  'ai-moments-caption': {
    en: [
      { q: 'What kinds of scenes work best?', a: 'Any everyday moment — coffee shop, sunset, late-night work, travel, food. The more vivid your description, the more tailored the captions.' },
      { q: 'Can I choose a specific style?', a: 'Yes. Pick Literary, Humorous, Minimal, Emotional, or Mixed (3 different styles in one go).' },
      { q: 'Will the captions feel robotic?', a: 'No. The AI is prompted to write like a real person posting to friends — no marketing tone, no AI clichés, no hashtag spam.' },
      { q: 'How long are the captions?', a: 'Each caption is 20-80 characters, suitable for WeChat moments, Instagram captions, or short social posts.' },
      { q: 'Is it free?', a: 'Yes, 5 free generations per day per IP, no signup required.' },
    ],
    zh: [
      { q: '什么场景适合用？', a: '任何日常瞬间都行 — 咖啡店、日落、加班、旅行、美食。描述越具体，文案越贴合。' },
      { q: '能选特定风格吗？', a: '能。可选文艺、幽默、简约、走心，或混合（一次出3种不同风格）。' },
      { q: '文案会不会像AI写的？', a: '不会。AI 被要求像真人发朋友圈一样写，没有营销腔、AI腔、话题标签堆砌。' },
      { q: '文案多长？', a: '每条 20-80 字，适合朋友圈、Instagram、短社交动态。' },
      { q: '免费吗？', a: '免费，每个 IP 每天 5 次，无需注册。' },
    ],
    es: [
      { q: '¿Qué tipos de escenas funcionan mejor?', a: 'Cualquier momento cotidiano — cafetería, atardecer, trabajo nocturno, viajes, comida. Cuanto más vívida la descripción, más personalizadas las leyendas.' },
      { q: '¿Puedo elegir un estilo específico?', a: 'Sí. Elige Literario, Humorístico, Minimalista, Emocional o Mixto (3 estilos diferentes a la vez).' },
      { q: '¿Las leyendas se sentirán robóticas?', a: 'No. La IA está programada para escribir como una persona real publicando para amigos, sin tono de marketing ni clichés.' },
      { q: '¿Cuánto miden las leyendas?', a: 'Cada leyenda tiene 20-80 caracteres, adecuada para publicaciones cortas en redes sociales.' },
      { q: '¿Es gratis?', a: 'Sí, 5 generaciones gratis por día por IP, sin registro.' },
    ],
    fr: [
      { q: 'Quels types de scènes fonctionnent le mieux ?', a: 'Tout moment quotidien — café, coucher de soleil, travail nocturne, voyage, nourriture. Plus la description est vivante, plus les légendes sont adaptées.' },
      { q: 'Puis-je choisir un style spécifique ?', a: 'Oui. Choisissez Littéraire, Humoristique, Minimaliste, Émotionnel ou Mixte (3 styles différents à la fois).' },
      { q: 'Les légendes sembleront-elles robotiques ?', a: 'Non. L\'IA est invitée à écrire comme une personne réelle publiant pour ses amis, sans ton marketing ni clichés.' },
      { q: 'Quelle est la longueur des légendes ?', a: 'Chaque légende fait 20-80 caractères, adaptée aux posts sociaux courts.' },
      { q: 'Est-ce gratuit ?', a: 'Oui, 5 générations gratuites par jour par IP, sans inscription.' },
    ],
    hi: [
      { q: 'कौन से दृश्य सबसे अच्छे हैं?', a: 'कोई भी दैनिक क्षण — कॉफी शॉप, सूर्यास्त, यात्रा, भोजन।' },
      { q: 'क्या मैं विशिष्ट शैली चुन सकता हूं?', a: 'हाँ। साहित्यिक, हास्य, न्यूनतम, भावनात्मक या मिश्रित।' },
      { q: 'क्या कैप्शन रोबोटिक लगेंगे?', a: 'नहीं। AI असली व्यक्ति की तरह लिखता है।' },
      { q: 'कैप्शन कितने लंबे हैं?', a: 'प्रत्येक 20-80 अक्षर।' },
      { q: 'क्या यह मुफ़्त है?', a: 'हाँ, प्रति IP प्रति दिन 5 मुफ़्त।' },
    ],
    ar: [
      { q: 'ما أنواع المشاهد الأنسب؟', a: 'أي لحظة يومية — مقهى، غروب، عمل متأخر، سفر، طعام.' },
      { q: 'هل يمكنني اختيار أسلوب محدد؟', a: 'نعم. أدبي، فكاهي، بسيط، عاطفي أو مختلط.' },
      { q: 'هل ستبدو التعليقات روبوتية؟', a: 'لا. يكتب الذكاء الاصطناعي كشخص حقيقي.' },
      { q: 'ما طول التعليقات؟', a: 'كل تعليق 20-80 حرفاً.' },
      { q: 'هل هو مجاني؟', a: 'نعم، 5 توليدات مجانية يومياً لكل IP.' },
    ],
  },
  'ai-smart-reply': {
    en: [
      { q: 'What relationships does it support?', a: 'Partner, boss, client, friend, family, crush — the AI adapts tone and formality to the relationship you pick.' },
      { q: 'Can it help me refuse politely?', a: 'Yes. Choose the "Refuse" goal and the AI crafts tactful, face-saving refusals that keep the relationship intact.' },
      { q: 'Are the replies natural?', a: 'Yes. The AI is prompted to avoid customer-service templates and oily pickup-artist tricks — replies sound like a real person.' },
      { q: 'Why does it show the reasoning?', a: 'Each reply comes with a short note explaining why it works, so you learn the communication logic, not just copy text.' },
      { q: 'Is it free?', a: 'Yes, 5 free generations per day per IP, no signup required.' },
    ],
    zh: [
      { q: '支持哪些关系？', a: '情侣、领导、客户、朋友、家人、暗恋对象 — AI 会根据关系调整语气和正式程度。' },
      { q: '能帮我委婉拒绝吗？', a: '能。选"委婉拒绝"目标，AI 会生成顾全面子的拒绝话术，不伤关系。' },
      { q: '回复自然吗？', a: '自然。AI 被要求避免客服模板和油腻套路，回复像真人说的话。' },
      { q: '为什么显示理由？', a: '每条回复附简短说明，解释为什么这么说，帮你学沟通逻辑，不只是抄话术。' },
      { q: '免费吗？', a: '免费，每个 IP 每天 5 次，无需注册。' },
    ],
    es: [
      { q: '¿Qué relaciones admite?', a: 'Pareja, jefe, cliente, amigo, familia, interés romántico — la IA adapta el tono y la formalidad.' },
      { q: '¿Puede ayudarme a rechazar educadamente?', a: 'Sí. Elige el objetivo "Rechazar" y la IA crea negativas tactful que mantienen la relación.' },
      { q: '¿Las respuestas son naturales?', a: 'Sí. La IA evita plantillas de servicio al cliente y trucos cursis — suenan como una persona real.' },
      { q: '¿Por qué muestra el razonamiento?', a: 'Cada respuesta incluye una nota breve que explica por qué funciona, para que aprendas la lógica de comunicación.' },
      { q: '¿Es gratis?', a: 'Sí, 5 generaciones gratis por día por IP, sin registro.' },
    ],
    fr: [
      { q: 'Quelles relations sont prises en charge ?', a: 'Partenaire, patron, client, ami, famille, craquage — l\'IA adapte le ton et la formalité.' },
      { q: 'Peut-il m\'aider à refuser poliment ?', a: 'Oui. Choisissez l\'objectif "Refuser" et l\'IA crée des refus tactful qui préservent la relation.' },
      { q: 'Les réponses sont-elles naturelles ?', a: 'Oui. L\'IA évite les templates de service client et les astuces huileuses — cela sonne comme une personne réelle.' },
      { q: 'Pourquoi affiche-t-il le raisonnement ?', a: 'Chaque réponse inclut une note courte expliquant pourquoi elle fonctionne, pour que vous appreniez la logique de communication.' },
      { q: 'Est-ce gratuit ?', a: 'Oui, 5 générations gratuites par jour par IP, sans inscription.' },
    ],
    hi: [
      { q: 'कौन से रिश्ते समर्थित हैं?', a: 'साथी, बॉस, ग्राहक, दोस्त, परिवार, क्रश।' },
      { q: 'क्या यह विनम्र अस्वीकृति में मदद करता है?', a: 'हाँ। "अस्वीकार" लक्ष्य चुनें।' },
      { q: 'क्या उत्तर प्राकृतिक हैं?', a: 'हाँ। AI असली व्यक्ति की तरह लिखता है।' },
      { q: 'यह तर्क क्यों दिखाता है?', a: 'प्रत्येक उत्तर में संक्षिप्त व्याख्या शामिल है।' },
      { q: 'क्या यह मुफ़्त है?', a: 'हाँ, प्रति IP प्रति दिन 5 मुफ़्त।' },
    ],
    ar: [
      { q: 'ما العلاقات المدعومة؟', a: 'شريك، مدير، عميل، صديق، عائلة، إعجاب.' },
      { q: 'هل يمكنه المساعدة في الرفض المهذب؟', a: 'نعم. اختر هدف "رفض".' },
      { q: 'هل الردود طبيعية؟', a: 'نعم. يكتب الذكاء الاصطناعي كشخص حقيقي.' },
      { q: 'لماذا يعرض التفكير؟', a: 'كل رد يتضمن شرحاً موجزاً.' },
      { q: 'هل هو مجاني؟', a: 'نعم، 5 توليدات مجانية يومياً لكل IP.' },
    ],
  },
  'ai-gift-recommender': {
    en: [
      { q: 'How does the AI pick gifts?', a: 'It considers the recipient, occasion, budget and interests you provide, then suggests 5 gifts at different price points with reasons and where to buy.' },
      { q: 'Are the gifts actually buyable?', a: 'Yes. The AI recommends real, commonly available items and suggests purchase channels (online marketplaces, physical stores). It won\'t invent fake brands.' },
      { q: 'Can I set a budget?', a: 'Yes. Enter a budget range (e.g. $20-50) and the AI keeps recommendations within or near that range, with 5 options at different price points.' },
      { q: 'What occasions does it support?', a: 'Birthday, anniversary, festival, thank-you and apology — each occasion steers the gift tone and type.' },
      { q: 'Is it free?', a: 'Yes, 5 free generations per day per IP, no signup required.' },
    ],
    zh: [
      { q: 'AI 怎么选礼物？', a: '根据你提供的对象、场合、预算和兴趣，推荐5个不同价位的礼物，附理由和购买渠道。' },
      { q: '推荐的礼物真的能买到吗？', a: '能。AI 推荐真实常见的商品，并建议购买渠道（线上商城、线下礼品店），不会编造品牌。' },
      { q: '能设预算吗？', a: '能。输入预算范围（如 200-500元），AI 会在范围内或附近推荐，5个选项价位不同。' },
      { q: '支持哪些场合？', a: '生日、纪念日、节日、答谢、道歉 — 每种场合会影响礼物调性和类型。' },
      { q: '免费吗？', a: '免费，每个 IP 每天 5 次，无需注册。' },
    ],
    es: [
      { q: '¿Cómo elige los regalos la IA?', a: 'Considera el destinatario, ocasión, presupuesto e intereses, y sugiere 5 regalos en diferentes precios con razones y dónde comprar.' },
      { q: '¿Los regalos se pueden comprar realmente?', a: 'Sí. La IA recomienda artículos reales y disponibles, y sugiere canales de compra. No inventa marcas falsas.' },
      { q: '¿Puedo fijar un presupuesto?', a: 'Sí. Ingresa un rango (ej. $20-50) y la IA mantiene las recomendaciones cerca de ese rango.' },
      { q: '¿Qué ocasiones admite?', a: 'Cumpleaños, aniversario, fiesta, agradecimiento y disculpa.' },
      { q: '¿Es gratis?', a: 'Sí, 5 generaciones gratis por día por IP, sin registro.' },
    ],
    fr: [
      { q: 'Comment l\'IA choisit-elle les cadeaux ?', a: 'Elle considère le destinataire, l\'occasion, le budget et les intérêts, puis suggère 5 cadeaux à différents prix avec raisons et où acheter.' },
      { q: 'Les cadeaux sont-ils vraiment achetables ?', a: 'Oui. L\'IA recommande des articles réels et disponibles, et suggère des canaux d\'achat. Elle n\'invente pas de fausses marques.' },
      { q: 'Puis-je fixer un budget ?', a: 'Oui. Entrez une fourchette (ex. 20-50€) et l\'IA garde les recommandations près de cette fourchette.' },
      { q: 'Quelles occasions sont prises en charge ?', a: 'Anniversaire, anniversaire de couple, fête, remerciement et excuse.' },
      { q: 'Est-ce gratuit ?', a: 'Oui, 5 générations gratuites par jour par IP, sans inscription.' },
    ],
    hi: [
      { q: 'AI उपहार कैसे चुनता है?', a: 'यह प्राप्तकर्ता, अवसर, बजट और रुचियों पर विचार करता है।' },
      { q: 'क्या उपहार वास्तव में खरीदे जा सकते हैं?', a: 'हाँ। AI वास्तविक वस्तुओं की सिफारिश करता है।' },
      { q: 'क्या मैं बजट सेट कर सकता हूं?', a: 'हाँ। बजट सीमा दर्ज करें।' },
      { q: 'कौन से अवसर समर्थित हैं?', a: 'जन्मदिन, वर्षगांठ, त्योहार, धन्यवाद, माफ़ी।' },
      { q: 'क्या यह मुफ़्त है?', a: 'हाँ, प्रति IP प्रति दिन 5 मुफ़्त।' },
    ],
    ar: [
      { q: 'كيف يختار الذكاء الاصطناعي الهدايا؟', a: 'يعتبر المستلم والمناسبة والميزانية والاهتمامات.' },
      { q: 'هل الهدايا قابلة للشراء فعلاً؟', a: 'نعم. يوصي الذكاء الاصطناعي بسلع حقيقية.' },
      { q: 'هل يمكنني تحديد ميزانية؟', a: 'نعم. أدخل نطاق الميزانية.' },
      { q: 'ما المناسبات المدعومة؟', a: 'عيد ميلاد، ذكرى، عطلة، شكر، اعتذار.' },
      { q: 'هل هو مجاني؟', a: 'نعم، 5 توليدات مجانية يومياً لكل IP.' },
    ],
  },
};
